...
export default function QuickAdd(){
 ...
 {(mode==="sale"||mode==="cashout"||mode==="cashin")&&<label>Amount<div className="quick-money"><input inputMode="decimal" value={amount} onChange={e=>setAmount(e.target.value.replace(/[^0-9.,\s-]/g,""))} placeholder="0,00"/><span>€</span></div></label>}
